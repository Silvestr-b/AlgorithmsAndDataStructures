...
const SinglyLinkedList_1 = require("../main/SinglyLinkedList");
const SinglyLinkedListNode_1 = require("../main/SinglyLinkedListNode");
describe('SinglyLinkedList', () => {
    ...
    let n4;
    beforeEach(() => {
        ll = new SinglyLinkedList_1.SinglyLinkedList();
        n1 = new SinglyLinkedListNode_1.SinglyLinkedListNode(1);
        n2 = new SinglyLinkedListNode_1.SinglyLinkedListNode(2);
        n3 = new SinglyLinkedListNode_1.SinglyLinkedListNode(3);
        n4 = new SinglyLinkedListNode_1.SinglyLinkedListNode(4);
    });
